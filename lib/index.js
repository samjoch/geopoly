...
(function() {
  ...
  Point.prototype.distanceWith = function(point) {
    ...
    return c * Geopoly.RADIUS; // returns meters
  }
   ...
   */
  Geopoly.RADIUS = 6378137; // meters
  Geopoly.RADIUS_IN_MILES = 3963.190592; // miles
  ...
  Geopoly.prototype.area = function() {
    ...
    return ( Math.abs(area) / 2 ) * Geopoly.RADIUS * Geopoly.RADIUS;
  };
